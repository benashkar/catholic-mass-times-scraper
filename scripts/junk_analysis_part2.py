...
COMMON_NOUNS_VERBS = {
    ...
    'meeting','meetings','class','classes','session','sessions',
    ...
    'education','religious','formation','sacrament','sacraments',
    ...
    'ministry','ministries','adoration','rosary','novena','stations',
    'anniversary','celebration',
    'retreat','camp','trip','pilgrimage',
    'book','books','library','study','studies',
    'pantry','shelter','outreach','mission','missions',
    'stewardship','evangelization','catechesis',
    'thank','thanks','welcome','blessed','blessing','prayer','pray',
    'volunteer','volunteering','serving','offering','donation','donate',
    'families','family','parent','parents','children','kids','youth','adult','adults','senior','seniors',
    'program','programs','event','events','activity','activities',
    'food','drive','breakfast','dinner','lunch',
}
