...
def main():
    ...
    blocklist = [
        ...
        "Holy Hour", "Holy Name", "Holy Cross", "Holy Rosary", "Holy Trinity",
        "First Reading", "Second Reading", "Gospel Reading",
        "Ordinary Time", "Jubilee Year", "Feast Day", "World Day",
        "Memorial Day", "Labor Day", "Thanksgiving Day",
        "New Year", "Happy New",
        "North America", "Latin America", "South America",
        "High School", "Middle School", "Grade School",
        "Main Street", "Mailing Address",
        "Auto Body", "Auto Repair", "Auto Insurance",
        "Smart Roofing", "Smart Driver",
        "Ice Cream Social", "Craft Bazaar", "Yard Sale",
        "Wine Pull", "Beer Tent", "Beer Dance",
        "Pizza Villa", "Pork Sausage", "Fried Chicken",
        "Ascension App", "Sports App",
        "Suggested Donation", "Contribution Statement",
        "Place Your Ad", "Safe Environment",
        "Dear Parishioners", "Dear Friends",
        "Immaculate Conception", "Immaculate Heart",
        "Virgin Mary", "Blessed Virgin",
        "Columbus Council", "Columbus Meeting",
        "Presbyteral Council", "Diocesan Council",
        "Finance Council", "Pastoral Council",
        "Lord Jesus", "Lord Jesus Christ",
        "The Knights", "Paul Society", "May God",
        "Jordan River", "Old Testament", "New Testament",
        "The Lord", "The Diocese", "The Epiphany", "The St",
        "Heavenly Father", "Thomas Aquinas",
        "Retirement Fund", "First Reconciliation",
        "Rice Bowl", "Respect Life", "Pro Life",
        "Poor Souls", "Faithful Departed", "Deceased Members",
        "Altar Server", "Music Ministry", "Shawl Ministry",
        "English Ministry", "Hispanic Ministry",
        "Brother Knight", "Grand Knight", "Deputy Grand",
        "Administrative Assistant", "Property Manager",
        "Development Manager", "Case Manager",
        "Extraordinary Minister", "Eucharistic Minister",
        "Volunteers Needed", "Sign Up",
        "Spring Alpha", "Generation To",
        "Doyle Vocal", "Vocal Quartet",
        "Stay Connected", "More Info",
        # Spanish/Latin liturgical phrases
        "Primera Comuni", "La Cuaresma", "El Evangelio",
        "Sacrosanctum Concilium", "Nueve Domingos",
        "El Comit", "Arroz La",
